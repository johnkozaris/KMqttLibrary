...
public class SampleActivity2 extends AppCompatActivity implements Connection.IReceivedMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnConnect= findViewById(R.id.buttonConnect2);
        Button btnSubscribe= findViewById(R.id.buttonSubscribe2);
        Button btnPublish= findViewById(R.id.buttonPublish2);
    ...
    private void Subscribe() {
        ...
        if (con.isConnected()) {
            Subscription subscription = new Subscription("/SecondTestTopic", 0, con.getId(), true);
            try {
    ...
    private void Publish() {
        ...
        if(con.isConnected()) {
            try {
                con.getClient().publish("/SecondTestTopic", new MqttMessage("hello2".getBytes()));
            } catch (MqttException e) {
                e.printStackTrace();
            }
        }
